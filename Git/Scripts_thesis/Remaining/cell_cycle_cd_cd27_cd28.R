...
output_base <- paste0(output_dir, "cell_cycle_cd3_cd27_cd28")
...
write.csv(overlap_genes, paste0(output_base, "_overlap_cell_cycle_cd3_cd27_cd28.csv"), row.names = FALSE)
