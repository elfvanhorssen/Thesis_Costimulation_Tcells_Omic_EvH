...
# 📌 Stap 2: Definieer de genenlijst voor Aerobic Glycolysis
...
# 📌 Stap 3: Filter de datasets op deze genen
...
# 📌 Stap 4: Filter en rangschik specifieke condities (samples)
# 👉 Pas deze vector aan met de gewenste condities in de juiste volgorde
...
# **Filter en herschik de kolommen in de gewenste volgorde**
...
# 🎨 Optionele kleurinstellingen voor de heatmaps
heatmap_colors_t <- colorRampPalette(c("blue", "black", "yellow"))(50)
heatmap_colors_p <- colorRampPalette(c("blue", "white", "red"))(50)


# 📌 Stap 5: Maak heatmaps voor transcriptomics en proteomics

# **Heatmap voor transcriptomics**
...
# ✅ Optioneel: Beide heatmaps naast elkaar plaatsen
